...
void real_estate() {
    ...
    //std::cout<<"tri:"<<n_buyers<<" "<<n_plots<<" "<<n_states<<std::endl;
    ...
    for( int i = 0; i < n_states; i++ ) {
        long state_limit;
        std::cin>>state_limit;
        eaG.addEdge(n_buyers+n_plots+i,v_target,state_limit,0);
    }
    ...
    for( int i = 0; i < n_plots; i++ ) {
        ...
        std::cin>>state;
        state-=1;
        eaG.addEdge(n_buyers+i,n_buyers+n_plots+state,1,0);
    }
    ...
    for( int i = 0; i < n_buyers; i++ ) {//Buyer
        for( int j = 0; j < n_plots; j++ ) {//Plot to buy
            ...
            eaG.addEdge(i,n_buyers+j,1,-willing_price);
        }
    }
